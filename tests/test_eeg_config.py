...
class EEGConfigTests(unittest.TestCase):
    def test_development_config_builds_32_channel_decoder_graph(self):
        ...
        self.assertEqual(config.policy.eye_abnormal_ratio, 1.20)
        self.assertEqual(config.policy.eye_single_feature_ratio, 1.55)
        self.assertEqual(config.policy.eye_mild_threshold, 1.30)
        self.assertEqual(config.policy.eye_moderate_threshold, 1.35)
        self.assertEqual(config.policy.eye_strong_threshold, 1.85)
